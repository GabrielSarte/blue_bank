...
class PixMinus extends StatefulWidget {

  const PixMinus({super.key});

  @override
  State<PixMinus> createState() => _PixMinusState();
}

class _PixMinusState extends State<PixMinus> {
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Enviar em qualquer hora e qualquer lugar', style: TextStyle(color: halfTonesColor, fontSize: 16))
                    ],
                  )
                ),
                Container(
                    ...
                    children: [
                      FormBuilderTextField(
                        ...
                        decoration: InputDecoration(
                          label: Text('Enviar para', style: TextStyle(color: highlightsColor, fontSize: 18)),
                          hintText: 'Nome',
